...
Also, for doing binary exploitation, there is an amazing python library called pwntools, and you are highly recommended to use it. We have provided a script `solution_template.py` that contains some code that you will find helpful.
...
Other notes
=======
1. If you encounter "libncurses.so.5: No such file or directory" error, please install it using "sudo apt-get install libncurses5" in Ubuntu.

2. Gdb-peda will be useful, you can install it from here https://github.com/longld/peda (GEF and pwndbg are good as well)
